  ...
  return (
    <section id="stihi" className="bg-bg-base py-24 px-6 sm:px-10">
      <div className="mx-auto max-w-3xl">
        ...
        {/* amount раньше был 0.15 — framer-motion считает эту долю от
            высоты ВСЕГО контейнера (10 карточек, на мобильных 390x700 —
            больше 3000px), так что триггер срабатывал только после
            ~500px прокрутки ВНУТРЬ списка. До этого момента карточки уже
            стоят на своих местах в layout, но с opacity:0 — на тёмном
            фоне это выглядит как большой пустой чёрный промежуток сразу
            под описанием, хотя на самом деле там уже лежит невидимый
            контент. amount: 0 запускает появление, как только контейнер
            хоть немного показался в вьюпорте. */}
        <motion.div
          variants={container}
          initial="hidden"
          whileInView="show"
